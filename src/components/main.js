...
import Courses from './../components/tab-contents/courses/Index'
import Students from './../components/tab-contents/students/students'
          ...
          [classes.contentShift]: open,
                    ...
                    <Route exact path={routes.root} render={props =>
                      ...
                      <Route exact path={routes.courses} render={props =>
                          (<Courses />)}/>
                      <Route exact path={routes.students} render={props => (<Students  />)}/>
                      <Route exact path={routes.update_course} render={props => (
                          <UpdateCourse />)}/>
                      <Route exact path={routes.new_course} render={props => (<NewCourse  />)}/>
                  </Switch> 
